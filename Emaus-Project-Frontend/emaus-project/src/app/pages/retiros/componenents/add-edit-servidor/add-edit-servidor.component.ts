...
export class AddEditServidorComponent implements OnInit {
  ...
  constructor(private router: Router, private servidoresService:ServidoresService, private ActivateRoute: ActivatedRoute, private fb:FormBuilder) {
    ...
    if(this.router.url.includes('editar')){
      this.ActivateRoute.params.subscribe({
        next: ({ idServidor, id }) => {
          ...
          this.getRetiroById(this.idServidor)
        },
      });
      this.edit = true
    } else {
